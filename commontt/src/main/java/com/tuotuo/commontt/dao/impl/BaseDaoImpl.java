...
import com.tuotuo.commontt.dao.BaseDao;
import com.tuotuo.commontt.model.Entity;
import com.tuotuo.commontt.model.Entity.Criteria;
import com.tuotuo.commontt.model.Entity.PrimaryKey;
import com.tuotuo.commontt.model.Entity.SimpleCriteria;
...
public class BaseDaoImpl<K extends Serializable, E extends Entity> implements BaseDao<K, E> {
	...
	protected String statement(String id) {
		return String.format("com.tuotuo.commontt.dao.%sDao.%s", entityClass.getSimpleName(), id);
	}
